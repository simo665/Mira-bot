...
from config import api_key, knowledge, personality, memory_length, save_threshold, encounters_error_messsage
import asyncio
...
class MistralCog(commands.Cog):
    def __init__(self, bot):
        ...
        self.encounters_error_messsage = encounters_error_messsage
    ...
    async def on_message(self, message):
        ...
        if self.bot.user in message.mentions:
            ...
            try:
                ...
                await message.channel.send(self.encounters_error_messsage)
                print(f"Error: {e}")
